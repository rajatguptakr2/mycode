...
// ----------------- Content Slider main class ---------------------------
	...
	content_slider.prototype = {
		...
		create_html: function () {
			...
			var i, img, real_i;
			var html_code = '<div class="'+this.options.container_class+'"><div class="image_more_info"><a href="#"><img alt="" src="'+this.options.plugin_url+'assets/plugins/slider/images/more.png"></a></div>';
			this._start = -1;
		...
		_create_arrows : function () {
			...
			if (this.options.hv_switch) {
				if (this.options.border_on_off==0 || this.options.use_thin_arrows==1) {
					html = '<div class="circle_slider_nav_left"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/left_vertical2.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/right_vertical2.png" alt="right" /></div>';
				} else {
				...
				if (this.options.border_on_off==0 || this.options.use_thin_arrows==1) {
					html = '<div class="circle_slider_nav_left"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/left2.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/right2.png" alt="right" /></div>';
				} else {
					html = '<div class="circle_slider_nav_left"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/left.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="'+this.options.plugin_url+'assets/plugins/slider/images/right.png" alt="right" /></div>';
				}
			}
			return html;
		},
